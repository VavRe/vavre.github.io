        ...
        <div class="relative z-10">
          <div class="mx-auto">
            ...
            <p class="mt-4 leading-relaxed text-gray-800">
              Grounded in a rigorous engineering background (B.Sc. Mechanical, M.Sc. AI) and professional experience as an AI/Software Engineer, I approach research with a builder's mindset. I strive to bridge the gap between rapid technological advancement and societal safety, designing architectures where innovation is robust, scalable, and socially and culturally competent by design. My work is driven by a deep interest in the <span class="font-semibold insist">safe integration of AI technology in our lives</span> — particularly from a social perspective — exploring how AI systems can be both powerful and responsible in the societies they operate within.
            </p>
          </div>
        </div>
      </header>
