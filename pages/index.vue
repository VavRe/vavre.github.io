<template>
  <div class="container mx-auto p-4 pt-[5rem] md:pt-4 flex flex-col md:flex-row md:items-start">
    ...
    <div class="fixed top-0 left-0 z-40 self-stretch w-full px-2 py-4 bg-white border shadow-lg border-primary-50 md:hidden flex items-center justify-between">
      ...
      <a href="/CV_Vahid_Rahimzadeh_Sep_2026.pdf" class="inline-block px-3 py-1.5 text-sm text-white transition duration-300 rounded bg-primary-600 hover:bg-primary-700 mr-4">
        Download CV
      </a>
    </div>
        ...
        <div class="relative z-10">
          <div class="mx-auto">
            <div class="flex items-center justify-between mb-4">
              ...
              <a href="/CV_Vahid_Rahimzadeh_Sep_2026.pdf" class="inline-block px-4 py-2 text-white transition duration-300 rounded bg-primary-600 hover:bg-primary-700">
                Download CV
              </a>
            </div>
