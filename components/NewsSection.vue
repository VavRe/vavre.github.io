...
const newsItems = [
  { date: 'Aug 2026', content: 'Our paper <b>Expectation, Backlash, Recovery, and Excitement: How Model Releases Shape Reddit Perceptions of Conversational AI Systems</b> accepted to <b>EMNLP 2026</b> Main Conference &mdash; explore the <a class="insist" href="/p/upai">interactive paper companion</a>' },
